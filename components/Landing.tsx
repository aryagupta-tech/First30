    ...
    <section className="editorial-hero" ref={heroRef}>
      <div className="editorial-hero-copy">
        ...
        <div className="editorial-actions">
          <NativeLink className="editorial-primary" href="/report?new=1">{pick('Start a report', 'रिपोर्ट शुरू करें')} <span>↗</span></NativeLink>
